...
tempData <- mice(data.work.merged,m=5, meth='pmm',seed=500)
summary(tempData)

tempData$imp$fin_situ_future
...
```{r}
data.work.final = select(completedData, -daysWorked,-survey_date_month, -survey_num, -unid)
```
