...
b = People who definitely assumed that numearnincome include self = numearnincome exceeds peoplelive by 1 (people who lies on the line shown below)
From graph, a>b.
...
We also removed all rows of data in which numearnincome>peoplelive
...
Whether numearnincome include self

The question is, do more people believe numearnincome includes themselves or not
